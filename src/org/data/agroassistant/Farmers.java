        ...
        if (requestCode == FNAME_SEARCH) {
        	...
        	if( resultCode == RESULT_OK) {
    			...
    			if(intent.getStringExtra("column").equals("Parish")){
        			...
        			apiResponse = fetchFarmerData(parish, PARISH_SEARCH);
